class SRender extends ash.System
{
	...
	{
		this.nodeList = engine.getNodeList( NRender );
	...
	private addToDisplay( node : NRender ) : void
	{
		this.container.addChild( node.display.displayObject );
	}
	
	private removeFromDisplay( node : NRender ) : void
	{
